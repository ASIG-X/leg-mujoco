...
class WirelessController(Node):
    def __init__(self, ctrl_mode: str, command_topic: str):
        ...
        if ctrl_mode == "ppo":
            ...
            raise ValueError("Invalid control mode. Use 'ppo'.")
    ...
    def publish_command(self):
        ...
        # Optional: Print current state (can be removed for production)
        import math
        print(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["ppo"],
        default="ppo",
        help="Control mode: 'ppo' for PPO-based commands",
    )
    parser.add_argument(
        "--topic",
        type=str,
        default="/velocity_command",
        help="ROS 2 geometry_msgs/PointStamped topic for PPO vx, vy, wz commands",
    )
    ...
    print(f"- ROS command topic: {args.topic if args.control == 'ppo' else args.control}")
